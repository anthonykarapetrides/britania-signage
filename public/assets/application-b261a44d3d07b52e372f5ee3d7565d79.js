        ...
        $.ajax({
            ...
            success: function (items) {
                ...
                $.each(items, function(index, item){
                    out += '<img src="/assets/britania_icon_sm.png" height="20px;"> <strong>' + item.title + ':</strong> ' + item.description;
                });
                news_feed.html(out);
                news_feed.marquee({
                    duration: 15000,
...
var feed_content = {
    ...
    quote: function(){
        ...
        var html = '<div class="media"><a class="pull-left" href="#">' +
            '<img class="media-object img-thumbnail" src="'+qotd.img_url+'" ></a><div class="media-body"><h4 class="media-heading">' +
            qotd.title + '</h4>'+ qotd.description + '</div></div>';
        $('#qotd').html(html);
    },
